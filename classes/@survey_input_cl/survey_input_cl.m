    ...
    methods
        function surv_input_obj=survey_input_cl(varargin)
            ...
            default_options=struct('Use_exclude_regions',1,'Absorption',nan,'Es60_correction',0,'Motion_correction',0,...
                'Vertical_slice_size',100,'Vertical_slice_units','pings','Horizontal_slice_size',10,'Remove_tracks',0,'Remove_ST',0,'Frequency',38000,'FrequenciesToLoad',38000,'FileType','Raw');
