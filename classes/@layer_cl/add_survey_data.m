...
[idx_files,idx_loaded,idx_missing,idx_nan]=find_survey_data(layer.Filename,survey_data_struct);
...
for i=1:length(surv_data)
    ...
    surv_temp=survey_data_cl('Voyage',survey_data_struct.Voyage{idx_loaded{i}(1)},...
        'SurveyName',survey_data_struct.SurveyName{idx_loaded{i}(1)},...
        'Snapshot',survey_data_struct.Snapshot(idx_loaded{i}(1)),...
        'Stratum',survey_data_struct.Stratum{idx_loaded{i}(1)},...
        'Transect',survey_data_struct.Transect(idx_loaded{i}(1)),...
