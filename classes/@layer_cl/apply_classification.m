...
%     
    ...
    %output_reg_18= layer.Transceivers(idx_18).integrate_region(school_18_reg,'denoised',0);
    output_reg_120= layer.Transceivers(idx_120).integrate_region(school_120_reg,'denoised',1);
