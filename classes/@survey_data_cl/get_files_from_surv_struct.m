function [pathtofiles,filenames]=get_files_from_surv_struct(surv_data_obj,surv_struct)


check_struct=@(struct) isempty(find(isfield(struct,{'Datapath' 'Voyage' 'SurveyName' 'Filename' 'Snapshot' 'Stratum' 'Transect' 'StartTime' 'EndTime'})==0, 1));
p = inputParser;
...
results=p.Results;
 ...
 pathtofiles=surv_struct.Datapath(idx);
