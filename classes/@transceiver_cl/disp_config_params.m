...
fig = figure('Position',[200 300 800 400],'Resize','off',...
    'Name',sprintf('Configuration/Parameters %s ping %d',trans_obj.Config.ChannelID,p.Results.idx_ping),'NumberTitle','off',...
