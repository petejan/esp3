...
for iuu=1:length(idx_reg)
    ...
    regCellInt=trans_obj.integrate_region_v3(reg_curr,'vertExtend',[reg_param.startDepth reg_param.finishDepth],'horiExtend',[p.Results.StartTime p.Results.EndTime],...
