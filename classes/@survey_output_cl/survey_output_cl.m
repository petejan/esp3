classdef survey_output_cl < handle
    ...
    methods
        function obj=survey_output_cl(nb_strat,nb_trans,nb_reg)
            ...
            obj.stratumSum =struct('snapshot',mat_de,'stratum',cell_de,'no_transects',...
                mat_de,'abscf_mean',mat_de,'abscf_sd',mat_de,'abscf_wmean',mat_de,'abscf_var',mat_de,...
                'abscf_with_shz_mean',mat_de,'abscf_with_shz_sd',mat_de,'abscf_with_shz_wmean',mat_de,'abscf_with_shz_var',mat_de,...
                'time_start',mat_de,'time_end',mat_de);
            
            mat_de=nan(1,nb_trans);
            cell_de={cell(1,nb_trans)};
            obj.transectSum = struct('snapshot',mat_de,'stratum',cell_de,'transect',mat_de,'dist',mat_de,'vbscf',mat_de,'abscf',mat_de,'mean_d',mat_de,'pings',mat_de,'av_speed',mat_de,'start_lat',mat_de,'start_lon',mat_de,'finish_lat',mat_de,'finish_lon',mat_de,'shadow_zone_abscf',mat_de,'time_start',mat_de,'time_end',mat_de);
