    ...
    methods
        function options=survey_options_cl(varargin)
            ...
            default_options=struct('Use_exclude_regions',1,'Absorption',nan,'Es60_correction',nan,'Motion_correction',0,...
                'Vertical_slice_size',100,'Vertical_slice_units','pings','Horizontal_slice_size',...
                10,'Remove_tracks',0,'Remove_ST',0,'Denoised',0,...
                ...
                'DepthMin',0,'DepthMax',Inf,'ExportSlicedTransects',0);
