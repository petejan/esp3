...
region_tab_comp.create_button=uicontrol(region_tab_comp.region_tab,'Style','pushbutton','String','Create Region','units','normalized','pos',[0.425 0.3 0.15 0.15],'callback',{@create_region_callback,main_figure});
uicontrol(region_tab_comp.region_tab,'Style','pushbutton','String','Delete Region','units','normalized','pos',[0.625 0.3 0.15 0.15],'callback',{@delete_region_callback,main_figure});
uicontrol(region_tab_comp.region_tab,'Style','pushbutton','String','Recompute Region','units','normalized','pos',[0.825 0.3 0.15 0.15],'callback',{@recompute_region_callback,main_figure});
