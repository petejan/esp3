...
gui_fmt.box_h=1.25;
gui_fmt.button_w=8;
gui_fmt.button_h=1.25;

gui_fmt.txtStyle=struct('Style','text','units','characters','HorizontalAlignment','right','BackgroundColor','white');
gui_fmt.txtTitleStyle=struct('Style','text','units','characters','HorizontalAlignment','center','BackgroundColor','white','Fontweight','Bold');
gui_fmt.edtStyle=struct('Style','Edit','units','characters','BackgroundColor','white');
gui_fmt.pushbtnStyle=struct('Style','pushbutton','units','characters');
gui_fmt.chckboxStyle=struct('Style','checkbox','Units','characters','BackgroundColor','white');
gui_fmt.popumenuStyle=struct('Style','popupmenu','Units','characters');
gui_fmt.lstboxStyle=struct('Style','listbox','Units','characters');
gui_fmt.radbtnStyle=struct('Style','radiobutton','Units','characters','BackgroundColor','white');
% 
% gui_fmt.x_sep=0.1;
% gui_fmt.y_sep=0.1;
% gui_fmt.txt_w=2;
