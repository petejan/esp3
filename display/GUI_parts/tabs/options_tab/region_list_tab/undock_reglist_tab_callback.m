...
%% Function
function undock_reglist_tab_callback(~,~,main_figure)
...
if~isvalid(reglist_tab_comp.reglist_tab)
    return;
end

switch class(reglist_tab_comp.reglist_tab)
...
undock_reglist_tab_callback(src,[],main_figure);
end