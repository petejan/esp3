...
data_logbook=dbconn.fetch('select Filename,Snapshot,Type,Stratum,Transect,Comment,StartTime,EndTime from logbook order by datetime(StartTime)');
...
type=data_logbook(:,3);
strat=data_logbook(:,4);
trans=cell2mat(data_logbook(:,5));
