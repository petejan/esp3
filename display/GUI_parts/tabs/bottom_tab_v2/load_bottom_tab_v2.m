...
bottom_tab_v2_comp.Shift_bot_sl=uicontrol(bottom_tab_v2_comp.bottom_tab,'Style','slider','Min',0,'Max',100,'Value',0,'SliderStep',[0.005 0.01],'units','normalized','Position',pos{3,5});
