...
bottom_tab_comp.r_min_sl=uicontrol(bottom_tab_comp.bottom_tab,'Style','slider','Min',0,'Max',1,'Value',0,'SliderStep',[0.01 0.1],'units','normalized','Position',pos{2,2});
...
bottom_tab_comp.r_max_sl=uicontrol(bottom_tab_comp.bottom_tab,'Style','slider','Min',0,'Max',1,'Value',1,'SliderStep',[0.01 0.1],'units','normalized','Position',pos{3,2});
...
bottom_tab_comp.Thr_backstep_sl=uicontrol(bottom_tab_comp.bottom_tab,'Style','slider','Min',-12,'Max',12,'Value',-1,'SliderStep',[0.01 0.1],'units','normalized','Position',pos{4,2});
...
set(bottom_tab_comp.Shift_bot_sl,'callback',{@sync_Sl_ed,bottom_tab_comp.Shift_bot_ed,'%g'});
set(bottom_tab_comp.Shift_bot_ed,'callback',{@sync_Sl_ed,bottom_tab_comp.Shift_bot_sl,'%g'});
