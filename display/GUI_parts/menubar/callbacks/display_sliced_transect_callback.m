...
[output_2D_surf,~]=trans_obj.slice_transect2D('Reference','Surface','Slice_w',Slice_w,'Slice_w_units',Slice_w_units,'Slice_h',Slice_h,'regIDs',[trans_obj.Regions(idx_reg).Unique_ID]);
