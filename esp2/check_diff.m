...
for i = 4:length(fn);
    ...
    strat_data_esp2=nan(1,length(echobsdata.stratum));
    ...
    clf;
    ax=axes();
    plot(strat_data_echo);hold on;
    plot(strat_data_esp2);
    grid on;
    legend('Matlab','Esp2')
...
for i = 4:length(fn);
    ...
    clf;
    ax=axes();
    plot(trans_data_echo);hold on;
    plot(trans_data_esp2);
    grid on;
    legend('Matlab','Esp2')
...
for i = 3:length(fn);
    ...
    for j = 1:length(echobsdata.transect)
        ...
        if i==8
            ...
            clf;
            title(fn{i})
            plot(trans_sliced_data_echo{j});
            hold on;
            plot(trans_sliced_data_esp2{j});
            grid on;
            legend('Matlab','Esp2')
...
for i = 7:length(fn);
    ...
    clf;
    ax=axes();
    plot(region_data_echo);hold on;
    plot(region_data_esp2);
    grid on;
    legend('Matlab','Esp2')
