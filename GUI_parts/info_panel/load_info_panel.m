...
if ~isempty(info_panel_comp)
    ...
    info_panel_comp.cursor_mode=uicontrol(info_panel_comp.info_panel,'Style','Text','String',cur_str,'units','normalized','Position',[0.7 0 0.3 0.5],'BackgroundColor',[1 1 1]);
