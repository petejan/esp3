...
% Modified by Y Ladroit 28/10/2015
% changed behavior while handing nan and naming fields
...
for c=1:nCol
    if ischar(header{c})
        ...
        name=matlab.lang.makeUniqueStrings(name,who,namelengthmax);
    else
        name = char('A'-1+c);
    end
