...
[sp,sv]=convert_power_lin(power,range,c,alpha,t_eff,t_nom,double(ptx),lambda,gain,eq_beam_angle,sacorr,trans_obj.Config.TransceiverName);  
[sp_noise,sv_noise]=convert_power_lin(power_noise,range,c,alpha,t_eff,t_nom,double(ptx),lambda,gain,eq_beam_angle,sacorr,trans_obj.Config.TransceiverName);
