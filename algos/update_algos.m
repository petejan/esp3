...
if found_bot>0
    trans_obj.Algo(idx_algo_bot).Varargin=struct('thr_bottom',get(bottom_tab_comp.Thr_bottom_sl,'Value'),...
...
if found_bp>0
    trans_obj.Algo(idx_algo_bp).Varargin=struct(...
        ...
        'thr_backstep',get(bad_ping_tab_comp.Thr_backstep_sl,'Value'),...
        'shift_bot',shift_bot,...
