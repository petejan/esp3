...
configXcvr.channelid = char(fread(fid,128,'char', 'l')');
...
configXcvr.spare2 = char(fread(fid,8,'char', 'l')');
configXcvr.gaintable = fread(fid,5,'float32', 'l');
configXcvr.spare3 = char(fread(fid,8,'char', 'l')');
configXcvr.sacorrectiontable = fread(fid,5,'float32', 'l');
configXcvr.spare4 = char(fread(fid,52,'char', 'l')');
