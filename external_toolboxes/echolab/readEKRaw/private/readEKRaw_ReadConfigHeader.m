...
configheader.surveyname = char(fread(fid,128,'char', 'l')');
configheader.transectname = char(fread(fid,128,'char', 'l')');
configheader.soundername = char(fread(fid,128,'char', 'l')');
configheader.spare = char(fread(fid,128,'char', 'l')');
