...
%                            Default: false
%
% tvgCorrectionFactor:  Set this parameter to true if you applied TVG correction.
%                       when you converted power to Sp/sp. IT IS ADVISED NOT TO
%                       CHANGE THIS UNLESS YOU KNOW WHAT YOU ARE DOING. For Sp/sp
%                       you should not apply the correction factor.
%                            Default: false
%       
%   OUTPUT:
