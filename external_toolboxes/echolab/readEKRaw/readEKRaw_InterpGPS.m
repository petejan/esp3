...
%                    data.  A value of 0 disables smoothing.  Negative values
...
for n=nsegStart:nsegEnd
    ...
    switch nFixesInSeg
        ...
        otherwise
            ...
            %  interpolate...
            latTemp(psIDX) = interp1(data.gps.time(segIDX), data.gps.lat(segIDX), ...
                data.pings(1).time(psIDX), method);
            lonTemp(psIDX) = interp1(data.gps.time(segIDX), data.gps.lon(segIDX), ...
                data.pings(1).time(psIDX), method);
