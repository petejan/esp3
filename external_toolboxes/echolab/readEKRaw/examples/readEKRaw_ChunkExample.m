...
rawFile = 'E:\Docs\Data misc\0001_20111020_033738_Tangaroa.all';
...
[header, firstRaw, rstat] = readEKRaw(rawFile, 'Frequencies', 18000, ...
    'PingRange', [1 350], 'Angles', false);
...
[header, secondRaw] = readEKRaw(rawFile, 'Frequencies', 18000, ...
