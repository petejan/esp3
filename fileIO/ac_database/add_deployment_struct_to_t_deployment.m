...
struct_in.deployment_start_date=cellfun(@(x) datestr(x,'yyyy-mm-dd'),num2cell(struct_in.deployment_start_date),'un',0);
struct_in.deployment_end_date=cellfun(@(x) datestr(x,'yyyy-mm-dd'),num2cell(struct_in.deployment_end_date),'un',0);
