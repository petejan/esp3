...
[~,transect_pkeys]=get_cols_from_table(ac_db_filename,'t_transect',...
    'input_cols',{'transect_snapshot','transect_stratum','transect_type','transect_number'},...
    'input_vals',{ac_db_struct.transect_snapshot,ac_db_struct.transect_stratum,ac_db_struct.transect_type,ac_db_struct.transect_number},...
