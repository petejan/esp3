...
diff_idx_peaks=[nan(1,nb_pings);diff(idx_peaks)];
idx_peaks=(diff_idx_peaks==1);

%
% idx_peaks=(peak_mat>=[nan(1,nb_pings);peak_mat(1:nb_samples-1,:)]&peak_mat>=[peak_mat(2:nb_samples,:);nan(1,nb_pings)])...
%      &idx_comp;
...
switch Transceiver.Mode
    ...
    otherwise
        [~,target_range_idx]=nanmax(samples_targets_power);
